function initRow(event_id) {
    this.event_id = event_id;
    this.age_std = arguments[1];
    this.agenums = new Array();
    for (var i = 2; i < arguments.length; i++) {
        this.agenums[i - 2] = arguments[i];
    }
    return (this);
}

function EstAGTime(form) {
    ...
    for (var ag_percentile = 50; ag_percentile < 100; ag_percentile++) {
        ...
        for (var distanceIndex = 0; distanceIndex < numdist; distanceIndex++) {
            ...
            // find age in AG_ages array that is closest to actual age, then calculate interpolation factor if necessary
            var iage1 = -1;
            var iage2 = 0;
            var i = 0;
            ...
            //document.writeln("iage1:"+iage1+" iage2:"+iage2+" factor:"+factor);
            ...
            var debug = 0;
            //o.document.write(AGfactors[distanceFactor].event_id + "<br>");
            if (debug)    o.document.write(totalseconds + "<br>");
            ...
            o.document.write("<td>" + ag_hrs + ":" + (ag_mns < 10 ? "0" + ag_mns : ag_mns) + ":" + (ag_scs < 10 ? "0" + ag_scs : ag_scs) + "</td>");
        }
        o.document.write("</tr>");
    }
