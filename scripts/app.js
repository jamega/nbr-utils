(function () {
    ...
    app.controller('AgeGradeController', function () {
        ...
        this.estimateAgeGradeTime = function () {
            ...
            AGfactors[i++] = new this.initRow("HalfMar", 3579, 0.7847, 0.8211, 0.8524, 0.8793, 0.9024, 0.9221, 0.9389, 0.9531, 0.9650, 0.9750, 0.9832, 0.9899, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 0.9957, 0.9888, 0.9820, 0.9751, 0.9404, 0.9121, 0.9050, 0.8685, 0.8380, 0.8304, 0.7901, 0.7555, 0.7469, 0.7000, 0.6586, 0.6483, 0.5898, 0.5198, 0.4255, 0.2698);
